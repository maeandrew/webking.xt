				...
				<div class="ca-item ca-item-<?=$n?>">
					<div class="ca-item-main">
						<a href="<?=_base_url.'/product/'.$i['id_product'].'/'.$i['translit']?>">
							<img height="100" alt="<?=$i['name']?>" src="<?=file_exists($GLOBALS['PATH_root'].$i['img_1'])?_base_url.htmlspecialchars(str_replace("/efiles/image/", "/efiles/image/250/", $i['img_1'])):'/efiles/_thumb/nofoto.jpg'?>">
							<h5><?=$i['name']?></h5>
						</a>
