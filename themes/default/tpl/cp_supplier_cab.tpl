						...
						<div class="products_list_item <?=isset($_SESSION['Assort']['products'][$i['id_product']]['active']) && $_SESSION['Assort']['products'][$i['id_product']]['active']?'available':'notavailable'?>" data-id-product="<?=$i['id_product']?>">
							...
							<div class="photo_cell">
								<div class="btn_js" data-name="big_photo">
									<?if($i['image'] != ''){?>
										<img class="toBigPhoto" id="big_photo_<?=$i['id_product']?>" alt="" height="90" src="<?=_base_url?><?=G::GetImageUrl($i['image'], 'thumb')?>" data-original-photo="<?=_base_url?><?=$i['image']?>">
									<?}else{?>
										<img class="toBigPhoto" id="big_photo_<?=$i['id_product']?>" alt="" height="90" src="<?=_base_url?><?=G::GetImageUrl($i['img_1'], 'thumb')?>" data-original-photo="<?=_base_url?><?=$i['img_1']?>">
									<?}?>
