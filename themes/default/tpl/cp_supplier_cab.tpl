						...
						<div id="tr_mopt_<?=$i['id_product']?>" class="products_list_item <?=isset($_SESSION['Assort']['products'][$i['id_product']]['active']) && $_SESSION['Assort']['products'][$i['id_product']]['active']?'available':'notavailable'?>">
							...
							<div class="photo_cell">
								<div class="btn_js" data-name="big_photo">
									<?if($i['image'] != ''){?>
										<img class="toBigPhoto" id="big_photo_<?=$i['id_product']?>" alt="" height="90" src="<?=_base_url?><?=str_replace("/original/", "/thumb/", $i['image'])?>" data-original-photo="<?=_base_url?><?=$i['image']?>">
									<?}else{?>
										<img class="toBigPhoto" id="big_photo_<?=$i['id_product']?>" alt="" height="90" src="<?=_base_url?><?=str_replace("/efiles/", "/efiles/_thumb/", $i['img_1'])?>" data-original-photo="<?=_base_url?><?=$i['img_1']?>">
									<?}?>
