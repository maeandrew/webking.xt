...
<?}elseif(isset($msg)){?><div class="notification success"> <span class="strong">Сделано!</span><?=$msg?></div><br><?}?>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" style="width: 802px;" class="table_main">
                            <tr>
                                 <td><p><?=$header['id_tovara']?></p></a></p></td>
                                 <td><p><?=$header['art_tovar']?></p></a></p></td>
                                 <td><p><?=$header['nazvanie_tovar']?></p></a></p></td>
                                <td><p><?=$header['opisanie']?></p></a></p></td>
                                 <td><p><?=$header['zena_opt']?></p></a></p></td>
                                <td><p><?=$header['zena_mopt']?></p></a></p></td>
                                 <td><p><?=$header['jasik']?></p></a></p></td>
                                 <td><p><?=$header['min_kol']?></p></a></p></td>
                                 <td><p><?=$header['kratnost']?></p></a></p></td>
                                <td><p><?=$header['edinizi']?></p></a></p></td>
                                 <td><p><?=$header['rasdel']?></p></a></p></td>
                                 <td><p><?=$header['art_rasdel']?></p></a></p></td>
                          ...
                          <?foreach ($katalog as $i){?>
                            ...
                            <tr>
                                 ...
                                 <td><p><?=$i['id_product']?></p></a></p></td>
                                 <td><p><?=$i['art_tovar']?></p></a></p></td>
                                 <td><p><?=$i['name_tovar']?></p></a></p></td>
                               <td><p><?=$i['descr']?></p></a></p></td>
                                  <td><p><?=$i['price_opt']?></p></a></p></td>                               
                               <td><p><?=$i['price_mopt']?></p></a></p></td>
                                 <td><p><?=$i['inbox_qty']?></p></a></p></td>
                               <td><p><?=$i['min_mopt_qty']?></p></a></p></td>
                                 <td><p><?=$i['qty_control']?></p></a></p></td>
                               <td><p><?=$i['units']?></p></a></p></td>                            
                                 <td><p><?=$i['name_katalog']?></p></a></p></td>
                                 <td><p><?=$i['art_katalog']?></p></a></p></td>
                                  <td><p>1</p></td>                                
