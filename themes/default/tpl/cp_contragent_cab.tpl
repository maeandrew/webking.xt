<div class="contragent_cab">
	...
	<div id="select_status_js" class="modal_hidden">
		<form action="<?=$GLOBALS['URL_request']?>" method="POST" class="select-status">
			...
			<button type="submit" name="change_status" class="btn-m-green">Подтвердить</button>
		</form>
	</div>
	<!-- CHANGE CLIENT MODAL FORM -->
	<div id="select_client_js" class="modal_hidden">
		<form action="<?=$GLOBALS['URL_request']?>" method="POST" class="select-client">
			...
			<button type="submit" name="change_client" class="btn-m-green">Подтвердить</button>
		</form>
	</div>
	<!-- MAKE BILL/INVOICE MODAL FORM -->
	<div id="bill_form_js" class="modal_hidden">
