			...
			<?foreach($parr as $i){?>
				<?if($i['mopt_qty']>0 && $i['id_supplier_mopt']==$id_supplier){?>
					<tr>
						...
						<td class="bl bt image"><img height="90" src="<?=file_exists($GLOBALS['PATH_root'].$i['img_1'])?_base_url.htmlspecialchars(G::GetImageUrl($i['img_1'], 'medium')):'/images/nofoto.png'?>"></td>
