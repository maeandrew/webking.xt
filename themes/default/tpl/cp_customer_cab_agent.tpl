<div class="row">
	<div class="customer_cab col-md-6">
		...
		<div class="license_agreement">
			<h2>Условия соглащения сотрудничества</h2>
			...
			<div class="confirm_block">
				...
				<form action="">
					<button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored confirm_btn_js" disabled="disabled">Продолжить</button>
				</form>
			</div>
		</div>
	</div>
