			...
			<div class="product_buy" data-idproduct="<?=$item['id_product']?>">
				<div class="buy_block" itemprop="offers" itemscope itemtype="http://schema.org/Offer">
					...
					<div class="btn_buy">
						...
						<button class="mdl-button mdl-js-button buy_btn_js <?=isset($_SESSION['cart']['products'][$item['id_product']])?'hidden':null;?>" type="button" onClick="ChangeCartQty($(this).closest('.product_buy').data('idproduct'), null); return false;" onClick="_gaq.push(['_trackEvent', 'Button', 'Click', 'kartochka', 'Ценность']);">Купить</button>
					</div>
					<div class="quantity">
