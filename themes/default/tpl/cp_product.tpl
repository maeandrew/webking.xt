...
<div class="product <?=isset($item['active']) && $item['active'] == 1?'active':'notactive';?>" itemscope itemtype="http://schema.org/Product">
	...
	<div class="mdl-button mdl-cell--hide-phone mdl-cell--hide-tablet product_label product_label_js btn_js" data-name="gift_products">
					...
					<div class="tab-content">
						<div id="description" class="mdl-tabs__panel">
							...
							<?}else{?>
								...
								<br>
								<p><strong>Платим 5 грн за описание или отзив товара.</strong></p>
								<p>Пример: написал  10 описаний получили 50 грн на мобильный телефон.</p>
								<br>
								<p>Действия:</p>
								<ul>
									...
									<li>- Уникальность 90%. (Скопированные описания не оплачиваются)</li>
								</ul>
								<p>Есть вопросы звоните 050 303 75 64, 067 544 72 55</p>
							<?}?>
						</div>
