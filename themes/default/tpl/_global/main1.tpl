...
<!-- 	<?if(in_array($GLOBALS['CurrentController'], array('main', '404')) || (isset($_SERVER['HTTP_REFERER']) && (strpos($_SERVER['HTTP_REFERER'], _base_url) === false))){?>
	...
	<?}?> -->
	<p class="contakt"><strong><span>(050) 30 98 420</span><span> (067) 57 41 013</span><span> (063) 42 59 183</span></p>
	<section class="main<?=$GLOBALS['CurrentController'] == 'product'?' product_page':null?>">
		<section class="center">
			
			<?if($GLOBALS['CONFIG']['agent_banner'] !== '' && screen.width < 800){?>
				<a class="agent_banner" href="https://invite.viber.com/?g2=AQBo6OY8wJHKiEmAOnwkK%2B%2FhtiFn72AmumPtCla4yUMIQTbkrbGAcKqmRyC9itqP">
					<span><?=$GLOBALS['CONFIG']['agent_banner'];?></span>
					<button class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent">Присоединиться к группе</button>
					<app-qr-code _ngcontent-community-landing-page-c13="" _nghost-community-landing-page-c19=""><vbr-qr _ngcontent-community-landing-page-c19=""><!-- <img src="data:image/png;base64," alt="Чтобы открыть &quot;ОПТ ХарьковТОРГ У&quot; в Viber, отсканируйте QR-код" style="width: 150px; height: 150px;"></vbr-qr></app-qr-code> -->
				</a>
			<?}?>
				...
				<div class="mdl-grid">
					<div id="seoTextBlock" class="mdl-grid mdl-cell--12-col">
						<?if(isset($_SESSION['member']) && in_array($_SESSION['member']['gid'], array(1, 2, 9, 14))){?>
							...
							<a id="seotext_editing" class="seotext_editing" href="<?=Link::Custom('adm', 'seotextedit');?>/<?=$seotext['id']?>" target="_blank">
								<i class="prod_editing_icon material-icons">mode_edit</i>
							</a>
