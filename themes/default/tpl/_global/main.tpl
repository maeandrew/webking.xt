		...
		<div id="verification" data-type="modal">
			...
			<div class="verification_meth hidden">
				<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
					...
					<input class="mdl-textfield__input phone" name="value" type="text" id="recovery_phone" value="<?=isset($User['phone'])?$User['phone']:'';?>" pattern="\+\d{2}\s\(\d{3}\)\s\d{3}\-\d{2}\-\d{2}\" disabled>
