	...
	<div id="cart" data-type="modal">
		...
		<div class="order_wrapp clearfix">
			...
			<div class="total">
				...
				<div class="positions">позиций: <span>8</span></div>
				<div class="total_summ">сумма: <span>88888,88</span></div>
			</div>
			<div class="action_block">
				<div class="wrapp">
					<div class="cart_info">
						<div class="your_discount">Ваша скидка составила 2000грн</div>
						<div class="tabs_container">
							<ul>
								<li class="in_cart_block">
					...
					<button class="mdl-button mdl-js-button btn_js" data-upgraded=",MaterialButton" data-name="cart">Продолжить покупки</button>
				</div>
				<div class="wrapp">
					<form action="#">
					...
					<button class="mdl-button mdl-js-button" data-upgraded=",MaterialButton">Оформить заказ</button>
				</div>
			</div>
		</div>
	</div>
