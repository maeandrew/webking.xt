			...
			<div class="product_buy" data-idproduct="<?=$p['id_product']?>">
				<div class="buy_block">
					...
					<?if($GLOBALS['CurrentController'] != 'main'){?>
						...
						<input type="number" class="qty_js" value="<?=isset($_SESSION['cart']['products'][$p['id_product']]['quantity'])?$_SESSION['cart']['products'][$p['id_product']]['quantity']:$p['inbox_qty']?>" onchange="ChangeCartQty($(this).closest('.product_buy').data('idproduct'), null);return false;">
						<div class="btn_buy">
							<label id="p_<?=$p['name']?>">
