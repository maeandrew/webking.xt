	...
	<div class="card clearfix">
		<div class="product_photo">
			<a href="#">
				...
				<?}else{?>
					<img alt="<?=G::CropString($item['id_product'])?>" class="lazy" data-original="http://xt.ua<?=$item['img_1']?htmlspecialchars(str_replace("/image/", "/image/250/", $item['img_1'])):"/images/nofoto.jpg"?>"/>
					<!-- <img alt="<?=G::CropString($item['id_product'])?>" class="lazy" data-original="<?=_base_url.($item['img_1']?htmlspecialchars(str_replace("/image/", "/image/250/", $item['img_1'])):"/images/nofoto.jpg")?>"/> -->
					<noscript>
