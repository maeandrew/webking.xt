		...
		<div class="product_photo">
			<a href="#">
				...
				<?}else{?>
					...
					<noscript><img alt="<?=G::CropString($item['id_product'])?>" src="<?=_base_url?><?=$item['img_1']?htmlspecialchars(str_replace("/image/", "/image/250/", $item['img_1'])):"/images/nofoto.jpg"?>"/></noscript>
				<?}?>
			</a>
		</div>
