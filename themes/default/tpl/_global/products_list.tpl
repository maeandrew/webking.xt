			...
			<div class="buy_block">
				<?if($GLOBALS['CurrentController'] != 'main'){?>
					...
					<div class="quantity">
						...
						<input type="text" class="minQty hidden" value="<?=isset($_SESSION['cart']['products'][$item['id_product']]['quantity'])?$_SESSION['cart']['products'][$item['id_product']]['quantity']:$item['inbox_qty']?>">
