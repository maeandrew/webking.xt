<div id="content">
		...
		<div class="blockline flexwrapp flexWrapReverse">
			...
			<div class="forflex blockOfText ">
				...
				<ul style="list-style: disc;">
					<li>доставка осуществляется по адресу (бесплатная услуга грузчика);</li>
					<li>без предоплаты, расчет по факту приема товара;</li>
					<li>регулярный маршрут, без опозданий;</li>
					<li>ответственность за груз в дороге на компании.</li>
				</ul>
			</div>
		</div>
	...
	<div id="page_information" class="page_information pages_group">
		<div class="blockline">
			...
			<h1>Справка</h1>
			<p>C целью повышения качества обслуживания, предлагаем Вам ознакомиться с перечнем часто задаваемых вопросов, касающихся деятельности нашей компании.</p>
		</div>
		<div class="blockline">
				...
				<section class="ac-container">
					...
					<div>
						...
						<article class="ac-small">
							<p>- для этого нужно  написать и оставить заявку по адресу - administration@xt.ua;</p>
		...
		<div id="question" class="content_modal_win" data-type="modal">
			<div class="modal_container">
				<div class="mdl-card__supporting-text">
					<p>Вы можете задать свой вопрос и получить ответ по электронной почте</p>
					<form class="forQuestion" action="">
	...
	<div id="page_payment" class="page_payment pages_group">
		...
		<div class="blockline">
			<div class="container flexwrapp">
				<div class="forflex blockOfText">
					...
					<p>Очень удобная система оплаты товаров и услуг в интернете не выходя из дома.</p>
					<a href="#" class="pos-left btn_plus">
						<span class="btn_plus_sign">+</span><span class="btn_plus_title">Как это работает</span>
					</a>
				</div>
		...
		<div class="blockline">
			<div class="container flexwrapp flexWrapReverse">
				...
				<div class="forflex blockOfText ">
					<h4>Оплата через банк</h4>
					<p>Для оплаты товара в нашем магазине, можно воспользоваться услугами банка.</p>
					<a href="#" class="pos-right btn_plus">
						<span class="btn_plus_title">Как это работает</span><span class="btn_plus_sign">+</span>
					</a>
				</div>
		...
		<div class="blockline">
			<div class="container flexwrapp">
				<div class="forflex blockOfText">
					...
					<p>Свой заказ Вы можете оплатить, при получении, курьеру или в пункте выдачи транспортной службы.</p>
					<a href="#" class="pos-left btn_plus">
						<span class="btn_plus_sign">+</span><span class="btn_plus_title">Как это работает</span>
					</a>
				</div>
		...
		<div class="blockline">
			<div class="container flexwrapp flexWrapReverse">
				...
				<div class="forflex blockOfText">
					...
					<p>Оплатить товары нашего магазина могут юридические и физические лица.</p>
					<a href="#" class="pos-right btn_plus">
						<span class="btn_plus_title">Как это работает</span><span class="btn_plus_sign">+</span>
					</a>
				</div>
		...
		<div class="invisibleblock">
			<div class="flexwrapp">
				<div>
					<img src="/themes/default/images/page/payment/cashless_calculation.png" alt="">
	...
	<div id="page_contacts" class="page_contacts ">
		<div class="blockline">
			...
			<div class="blockOfText contactText">
				<p class="main_text ">С нами можно связаться:</p>
				<p>(050) 309-84-20</p>
				<p>(067) 574-10-13</p>
			...
			<div class="modal_container blockForForm">
				<div class="mdl-card__supporting-text">
					...
					<form action="">
						...
						<div class="mdl-textfield mdl-js-textfield">
							<textarea class="mdl-textfield__input" type="text" rows= "3" id="sample5" ></textarea>
							<label class="mdl-textfield__label" for="sample5">Ваши предложения и пожелания...</label>
						</div><br>
					</form>
				</div>
				<div class="mdl-card__actions mdl-card--border">
		...
		<div id="lament" class="content_modal_win" data-type="modal">
			<div class="modal_container blockForForm">
				<div class="mdl-card__supporting-text">
					...
					<form action="">
						...
						<div class="mdl-textfield mdl-js-textfield">
							<textarea class="mdl-textfield__input" type="text" rows= "3" id="sample5" ></textarea>
							<label class="mdl-textfield__label" for="sample5">Введите текст...</label>
						</div><br>
					</form>
				</div>
				<div class="mdl-card__actions mdl-card--border">
					<button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored mdl-js-ripple-effect">Отправить жалобу</button>
				</div>
			</div>
		</div>
	</div>
