<div id="content">
	...
	<div id="page_delivery" class="page_delivery ">
		<div class="blockline">
			<img class="main_img forflex" src="/themes/default/images/page/delivery/delivery1.png" alt="">
			<h1>Доставка</h1>
		</div>
	...
	<div id="page_information" class="page_information four_pages">
		...
		<div class="blockline">
			...
			<div class="container flexwrapp">
				...
				<div class="forflex"><img src="/themes/default/images/page/info/info2.png" alt="someimg"></div>
			</div>
		</div>
		...
		<div class="blockline ">
			...
			<div class="container flexwrapp flexWrapReverse">
				<div class="forflex"><img src="/themes/default/images/page/info/info3.png" alt="someimg"></div>
				<div class="forflex blockOfText ">
	...
	<div id="page_payment" class="page_payment four_pages ">
		...
		<div class="blockline">
			...
			<div class="container flexwrapp">
				...
				<div class="forflex"><img src="/themes/default/images/page/payment/payment1.png" alt="someimg"></div>
			</div>
		</div>
		...
		<div class="blockline ">
			...
			<div class="container flexwrapp flexWrapReverse">
				<div class="forflex"><img src="/themes/default/images/page/payment/payment2.png" alt="someimg"></div>
				<div class="forflex blockOfText ">
					<h4>Офф-лайн оплата</h4>
		...
		<div class="blockline">
			...
			<div class="container flexwrapp">
				...
				<div class="forflex"><img src="/themes/default/images/page/payment/payment3.png" alt="someimg"></div>
			</div>
		</div>
		<div class="invisibleblock">
			<div class="forflex">
		...
		<div class="blockline">
			...
			<div class="container flexwrapp flexWrapReverse">
				<div class="forflex"><img src="/themes/default/images/page/payment/payment4.png" alt="someimg"></div>
				<div class="forflex blockOfText">
					<h4>Безналичный расчёт</h4>
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit</p>
				</div>
	...
	<div id="page_provision_companies" class="page_provision_companies four_pages ">
		...
		<div id="estimateLoad" data-type="modal">
			<div class="modal_container blockForForm">
				<div class="mdl-card__supporting-text">
