			...
			<form id="edit_contacts" class="editing" action="" method="post">
				...
				<?switch($var){
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						...
						<input class="mdl-textfield__input" pattern="+@[a-zA-Z_]+\.[a-zA-Z]" type="text" name="email" id="email" value="<?=$User['email']?>"/>
					...
					<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
						...
						<input class="mdl-textfield__input phone" type="tel" required name="phones" id="phones" value="<?=$User['phones']?>" pattern="\+\d{2}\s\(\d{3}\)\s\d{3}\-\d{2}\-\d{2}\"/>
