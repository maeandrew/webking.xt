...
$(function(){
	...
	$('#password_recovery').on('click', 'label[for="chosen_mail"]', function(e){
	...
	$('#password_recovery').on('click', 'label[for="chosen_sms"]', function(e){
		$('#password_recovery #recovery_email').closest('div').addClass('hidden');
	...
	$('#password_recovery').on('click', 'button', function(e){
