			...
			<?if(isset($products[$s['id_supplier']])){
				...
				<?if($i['opt_qty'] != 0){// строка по опту?>
					<tr class="animate">
						<td><?=$i['article']?></td>
						<td class="name_cell">
							<a href="<?=($i['img_1'])?htmlspecialchars($i['img_1']):"/images/nofoto.png"?>" onclick="return hs.expand(this)" style="float: left;"><img alt="" width="70px" src="<?=($i['img_1'])?htmlspecialchars(G::GetImageUrl($i['img_1'], 'thumb')):"/images/nofoto.png"?>" title="Нажмите для увеличения"></a>
