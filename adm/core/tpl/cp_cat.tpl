...
<div class="wrapp">
    <ul class="main_cat">
        ...
        <div class="fl">
        <span class="article"><?=$l1['art']?></span>
        ...
        <a class="icon-font lockcat" style="<?=!$l1['visible']?'visibility: hidden':null;?>" title="Посмотреть категорию на сайте" href="<?=_base_url?>/<?=$l1['translit']?>">v</a>
        </div>
        <?if(!empty($l1['subcats'])){?>
        ...
        <div class="fl">
        <span class="article"><?=$l2['art']?></span>
        ...
        <a class="icon-font lockcat" style="<?=!$l2['visible']?'visibility: hidden':null;?>" title="Посмотреть категорию на сайте" href="<?=_base_url?>/<?=$l2['translit']?>/">v</a>
        </div>
        <?if(!empty($l2['subcats'])){?>
        ...
        <div class="fl">
        <span class="article"><?=$l3['art']?></span>
        ...
        <a class="icon-font lockcat" style="<?=!$l3['visible']?'visibility: hidden':null;?>" title="Посмотреть категорию на сайте" href="<?=_base_url?>/<?=$l3['translit']?>/">v</a>
        </div>
        </li>
        <?}?>
        </ul>
